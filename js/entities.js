...
//         options: [{
//           text: `Buy Canvas ($5)`,
//           nextState: 'buy_canvas_options',
//         }, {
//           text: `Buy Paper ($1)`,
//           nextState: 'buy_paper_options',
//         }, {
//           text: `Buy Pencils ($2)`,
//           nextState: 'buy_pencil_options',
//         }, {
//           text: `Buy Paint Brushes ($8)`,
//           nextState: 'buy_brush_options',
//         }, {
//           text: `Buy Watercolor Set ($15)`,
//           nextState: 'buy_watercolor_options',
//         }, {
//           text: `Buy Oil Paint Set ($25)`,
//           nextState: 'buy_oilpaint_options',
//         }, {
//           text: `Maybe later.`,
//           nextState: 'end',
//         }]
//       },
//       // New sub-dialogues for multiple quantity purchases
//       'buy_canvas_options': {
//         text: `How many canvases would you like? Each costs $5.`,
//         options: [
//           { text: `1 Canvas ($5)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 5 } }, { id: 'addItemToBackpack', params: { item: 'canvas', quantity: 1 } }] },
//           { text: `5 Canvases ($25)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 25 } }, { id: 'addItemToBackpack', params: { item: 'canvas', quantity: 5 } }] },
//           { text: `10 Canvases ($50)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 50 } }, { id: 'addItemToBackpack', params: { item: 'canvas', quantity: 10 } }] },
//           { text: `Nevermind`, nextState: 'shop_menu' }
//         ]
//       },
//       'buy_paper_options': {
//         text: `How much paper would you like? Each costs $1.`,
//         options: [
//           { text: `1 Paper ($1)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 1 } }, { id: 'addItemToBackpack', params: { item: 'paper', quantity: 1 } }] },
//           { text: `10 Paper ($10)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 10 } }, { id: 'addItemToBackpack', params: { item: 'paper', quantity: 10 } }] },
//           { text: `50 Paper ($50)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 50 } }, { id: 'addItemToBackpack', params: { item: 'paper', quantity: 50 } }] },
//           { text: `Nevermind`, nextState: 'shop_menu' }
//         ]
//       },
//       'buy_pencil_options': {
//         text: `How many pencils would you like? Each costs $2.`,
//         options: [
//           { text: `1 Pencil ($2)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 2 } }, { id: 'addItemToBackpack', params: { item: 'pencil', quantity: 1 } }] },
//           { text: `3 Pencils ($6)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 6 } }, { id: 'addItemToBackpack', params: { item: 'pencil', quantity: 3 } }] },
//           { text: `5 Pencils ($10)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 10 } }, { id: 'addItemToBackpack', params: { item: 'pencil', quantity: 5 } }] },
//           { text: `Nevermind`, nextState: 'shop_menu' }
//         ]
//       },
//       'buy_brush_options': {
//         text: `How many paint brushes would you like? Each costs $8.`,
//         options: [
//           { text: `1 Brush ($8)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 8 } }, { id: 'addItemToBackpack', params: { item: 'brush', quantity: 1 } }] },
//           { text: `3 Brushes ($24)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 24 } }, { id: 'addItemToBackpack', params: { item: 'brush', quantity: 3 } }] },
//           { text: `Nevermind`, nextState: 'shop_menu' }
//         ]
//       },
//       'buy_watercolor_options': {
//         text: `How many watercolor sets would you like? Each costs $15.`,
//         options: [
//           { text: `1 Set ($15)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 15 } }, { id: 'addItemToBackpack', params: { item: 'watercolor', quantity: 1 } }] },
//           { text: `2 Sets ($30)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 30 } }, { id: 'addItemToBackpack', params: { item: 'watercolor', quantity: 2 } }] },
//           { text: `Nevermind`, nextState: 'shop_menu' }
//         ]
//       },
//       'buy_oilpaint_options': {
//         text: `How many oil paint sets would you like? Each costs $25.`,
//         options: [
//           { text: `1 Set ($25)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 25 } }, { id: 'addItemToBackpack', params: { item: 'oil_paint', quantity: 1 } }] },
//           { text: `2 Sets ($50)`, nextState: 'end', actions: [{ id: 'spendMoney', params: { amount: 50 } }, { id: 'addItemToBackpack', params: { item: 'oil_paint', quantity: 2 } }] },
//           { text: `Nevermind`, nextState: 'shop_menu' }
//         ]
//       },
//       'end': {
...
//     }
//   },
//   art_collector: { // New Art Collector entity
//     name: "Art Collector",
//     x: 6, // Example position in art_district
//     y: 12,
//     sprite: "#00bfff", // Deep Sky Blue
//     dialogue: {
//       'start': {
//         text: `Greetings, artist! I'm always looking for unique pieces to add to my collection. Do you have anything to sell?`,
//         options: [
//           { text: `Show me what you buy.`, nextState: 'selling_menu' },
//           { text: `No, not right now.`, nextState: 'end' }
//         ]
//       },
//       'selling_menu': {
//         text: `I'm interested in:`,
//         options: [
//           // This will be dynamically populated in a later step using custom action or by helper function
//           // For now, let's list some potential art pieces you can make
//           {
//             text: `Sell Pencil Sketch ($10)`,
//             nextState: 'sell_pencil_sketch',
//             conditions: [{ type: 'hasItem', itemId: 'pencil_sketch', quantity: 1 }],
//           },
//           {
//             text: `Sell Watercolor Painting ($45)`,
//             nextState: 'sell_watercolor_painting',
//             conditions: [{ type: 'hasItem', itemId: 'watercolor_painting', quantity: 1 }],
//           },
//           {
//             text: `Sell Oil Painting ($150)`,
//             nextState: 'sell_oil_painting',
//             conditions: [{ type: 'hasItem', itemId: 'oil_painting', quantity: 1 }],
//           },
//           {
//             text: `Sell Clay Sculpture ($80)`,
//             nextState: 'sell_clay_sculpture',
//             conditions: [{ type: 'hasItem', itemId: 'clay_sculpture', quantity: 1 }],
//           },
//           { text: `Nothing else for now.`, nextState: 'end' }
//         ]
//       },
//       'sell_pencil_sketch': {
//         text: `Ah, a classic! Here's $10 for your sketch.`,
//         options: [{
//           text: `Thank you!`,
//           nextState: 'end',
//           actions: [
//             { id: 'removeItemFromBackpack', params: { item: 'pencil_sketch', quantity: 1 } },
//             { id: 'addMoney', params: { amount: 10 } }
//           ]
//         }]
//       },
//       'sell_watercolor_painting': {
//         text: `A delightful watercolor! $45 for this piece.`,
//         options: [{
//           text: `Much obliged!`,
//           nextState: 'end',
//           actions: [
//             { id: 'removeItemFromBackpack', params: { item: 'watercolor_painting', quantity: 1 } },
//             { id: 'addMoney', params: { amount: 45 } }
//           ]
//         }]
//       },
//       'sell_oil_painting': {
//         text: `Exquisite oil work! This is worth $150.`,
//         options: [{
//           text: `Fantastic!`,
//           nextState: 'end',
//           actions: [
//             { id: 'removeItemFromBackpack', params: { item: 'oil_painting', quantity: 1 } },
//             { id: 'addMoney', params: { amount: 150 } }
//           ]
//         }]
//       },
//       'sell_clay_sculpture': {
//         text: `A strong form in clay! $80 for your sculpture.`,
//         options: [{
//           text: `Excellent!`,
//           nextState: 'end',
//           actions: [
//             { id: 'removeItemFromBackpack', params: { item: 'clay_sculpture', quantity: 1 } },
//             { id: 'addMoney', params: { amount: 80 } }
//           ]
//         }]
//       },
//       'end': {
//         text: `Do come back if you create more masterpieces!`,
//         options: []
//       }
//     },
//     dialogueLogic: [
//       { // Rule for showing selling menu if player has any sellable items
//         conditions: [
//           { type: 'hasItem', itemId: 'pencil_sketch', quantity: 1 },
//           { type: 'hasItem', itemId: 'watercolor_painting', quantity: 1 },
//           { type: 'hasItem', itemId: 'oil_painting', quantity: 1 },
//           { type: 'hasItem', itemId: 'clay_sculpture', quantity: 1 }
//         ],
//         targetState: 'selling_menu'
//       },
//       { // Default to start if no items to sell
//         conditions: [],
//         targetState: 'start'
//       }
//     ]
